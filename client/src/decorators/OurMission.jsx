  ...
  return (
    <section className="ourMission">
      <div className="imageContainer">
        <img
          src="https://img.freepik.com/premium-photo/man-touching-mission-text-screen_218381-4228.jpg"
          alt="our mission"
        />
      </div>
      <div className="textWrapper">
        ...
        <p>
          At <span className="themeText">Chagans Technologies Limited</span>,
          our goal is to help businesses manage their finances more easily using
